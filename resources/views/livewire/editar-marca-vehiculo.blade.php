<div>
    ...
    <form wire:submit.prevent="actualizar" class="mx-auto bg-blue-200 p-6 shadow-md space-y-4">
        ...
        <button type="submit" wire:loading.attr="disabled" wire:target="actualizar"
            class="inline-flex items-center justify-center text-white text-sm font-medium rounded-lg px-5 py-2.5 text-center me-2
