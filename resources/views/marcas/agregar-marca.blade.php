...
@section('contenido-central')
    ...
    @csrf    
        ...
        <div>
            ...
            <input type="text" name="nombre_marca" id="nombre" value="{{ old('nombre_marca') }}" required class="mt-1 block w-full rounded-lg border border-gray-300 p-2 focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500">
            @error('nombre_marca')
