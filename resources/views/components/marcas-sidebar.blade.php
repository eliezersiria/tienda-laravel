...
<nav class="h-screen bg-gray-800 text-white flex flex-col p-4">        
    ...
    <a href="{{ route('marcas.trash') }}" class="flex items-center gap-3 py-2 px-4 rounded hover:bg-gray-700 transition {{ request()->routeIs('marcas.trash') ? 'bg-black text-white font-semibold border-b-2 border-white text-white' : ' ' }}">
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
